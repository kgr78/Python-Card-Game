...
public class Monster {
	 ...
	 * 
	 * Initializes its name, faintStatus, description, health, attack1, attack2, attack3, attack odds, upper and lower health range and upper and lower attack ranges, selling buying prices and upper and lower price ranges
	*/
	public Monster(String name, boolean faintStatus, String description, int health, int attack1, int attack2, int attack3, int odds1, int odds2, int odds3, int health_upper, int health_lower, int att1_upper, int att1_lower, int att2_upper, int att2_lower, int att3_upper, int att3_lower, int healAmount, int sellingPrice, int buyingPrice, int lowPrice, int upPrice) {
		this.name = name;
	...
	*/
	...
	/**Returns the monster details for the item shop */ 
	public String storeMonString() {
		String name = "Name: "+getName()+"\n";
		String health = "Health: "+getCurrentHealth()+"\n";
		String heal = "Heal Amount: "+getHealAmount()+"\n";
		String attack1 = "Attack1: "+getAttack(1)+" / Accuracy: "+getAttackOdds1()+"%"+"\n";
		...
		return name+health+heal+attack1+attack2+attack3+buyPrice+sellPrice;
	}
}