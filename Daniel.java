public class Daniel extends Monster {
	...
	*/
	public Daniel(int health, int attack1, int attack2, int attack3) {
		super("Daniel", false, "Although its health isn't the greatest with all the takeaways it eats, it is the hardest hitting Monster purely due to its leverish arms.", health, attack1, attack2, attack3, 70, 60, 30, 180, 80, 50, 25, 60, 35, 100, 75, 110);
	}
