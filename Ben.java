public class Ben extends Monster{
	...
	*/
	public Ben(int health, int attack1, int attack2, int attack3) {
		super("Ben", false, "More of a Warrior than a Monster. It's nickname on the street is the 3rd Splash Bro. Stuns enemies with its devastating gas.", health, attack1, attack2, attack3, 100, 25, 10, 200, 100, 30, 5, 80, 55, 180, 155, 130);
	}
}
