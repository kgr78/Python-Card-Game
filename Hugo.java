public class Hugo extends Monster 
{
	...
	*/
	public Hugo(int health, int attack1, int attack2, int attack3) {
		super("Hugo", false, "A very calculated Monster. Rarely misses attacks due to the monster's understanding of probability thereom. Also extremely tanky due to diet of chicken jalfrezi.", health, attack1, attack2, attack3, 100, 95, 85, 300, 200, 28, 3, 31, 6, 40, 15, 230);
	}
}
